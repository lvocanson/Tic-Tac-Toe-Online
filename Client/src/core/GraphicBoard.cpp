...
void GraphicBoard::InstanciateNewPlayerShape(const TicTacToe::PieceID pieceId, unsigned int cell)
{
	...
	const auto playerPieceShape = new PlayerPieceShape(pieceId, pos);
